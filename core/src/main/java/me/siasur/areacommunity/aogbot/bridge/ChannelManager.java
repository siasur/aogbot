...
public class ChannelManager implements IChannelManager {
	...
	public void locateClient(final AoGClient client) {
	 ...
	 * 
	 * @param clients
	 *            the {@link List<IAoGClient>} of clients that should be located.
	 */
	public void locateClients(final List<IAoGClient> clients) {
		for (final IAoGClient client : clients) {
			locateClient((AoGClient) client);
		}
	}
	 ...
	 * 
	 * @param channels
	 *            the {@link List<Channel>} of Channels
	 */
